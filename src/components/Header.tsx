...
const Header: React.FC = () => {
    ...
    return (
        <header
            className={`w-full py-5 fixed top-0 left-0 duration-400 ${isScrolled ? 'bg-white border-b border-gray-200' : 'bg-transparent border-b border-transparent text-white'}`}>
